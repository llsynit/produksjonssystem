...
#RUN apt install python3.7 python3.7-distutils python3.7-dev python3-pip python3-apt
...
#RUN npm install
#RUN PUPPETEER_SKIP_CHROMIUM_DOWNLOAD=true npm install @daisy/ace -g
...
#RUN apt-get install -qy ttf-mscorefonts-installer

#cabextract and xfonts-util necessary mscorefonts
...
#RUN apt-get install cryptography
#RUN apt-get install -y epubcheck
